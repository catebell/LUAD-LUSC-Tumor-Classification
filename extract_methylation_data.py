...
def create_meth_df(case_id: str, file_mapping_df: pd.DataFrame, genes_mapping_df: pd.DataFrame, meth_manifest_df: pd.DataFrame):
    ...
    print("Getting gene name variants...")
    ...
    print("\nGrouping by gene_id and averaging b-values (weighted avg based on position)...")
    pos_priority_map = {
        'Island': 1.0,
        'N_Shore': 0.8,
        'S_Shore': 0.8,
